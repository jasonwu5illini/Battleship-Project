/**
 * 
 *  class representing an Aircraft Carrier in our game
 *
 *  @author  benjamin
 *  @version May 19, 2020
 *  @author  Period: 3
...
public class Car extends boat
{
    ...
    Car(position p, String d){
        ...
        if(!"NWES".contains( d ) || d.length() != 1) {
            ...
            if(d.equals("N")) {
                ...
                pos[4] = new position( pos[0].getX(), pos[0].getY() + 4);
                ...
                pos[4] = new position( pos[0].getX() - 4, pos[0].getY());
    ...
    /**
     * returns the name of the ship "carrier"
    ...
    public boolean isValid(boat b1, boat b2, boat b3, boat b4)
    {
        ...
        for(position p : pos) {
            ...
            for(position other : b4p) {
                if (p.isSame( other )){
                    System.out.println("Ship overlap with Battleship");
                    return false;
                }
            }
        }
     ...
     * @param b3 a boat to check overlap with
     * @param b4 a boat to check overlap with 
     * @return if the placement is valid or not
     */
    public boolean isValidNoMSG(boat b1, boat b2, boat b3, boat b4)
    {
        // TODO Auto-generated method stub
        position[] b1p = b1.getPos();
        position[] b2p = b2.getPos();
